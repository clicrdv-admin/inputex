        ...
        YUI : function(cfg) {
            if (typeof(YUI) === 'undefined') {
                ...
                return {
                    ...
                    use:function() {
                        if (typeof(YUI) !== 'undefined') {
                            YUI.use.apply(YUI(inputEx.yuiProfile), arguments);
                        } else {
                            function delegate(that, thatMethod, args) {
                                return function() { return thatMethod.apply(that, args); }
                            }
                            window.setTimeout(delegate(this, this.use, arguments), 500)
                        }
                    }
                }
            } else {
                return YUI(inputEx.yuiProfile);
            }
        },

        yuiProfile :{base:"../lib/yui3/", timeout: 10000,
            modules: {
                'inputex-css':{
